...
import { signUpWithCredentials } from "../application/credentials.use-cases";
import { getClientToken } from "../application/session.client";
import { passwordsMatch } from "../domain/session.rules";
...
export default function SignupScreen() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!passwordsMatch(data.password, data.passwordConfirm)) {
